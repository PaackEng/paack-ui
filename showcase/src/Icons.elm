...
icons =
    ...
    , ( Icon.currencyNote, "currencyNote" )
    ...
    , ( Icon.personRemove, "personRemove" )
    , ( Icon.personUnassign, "personUnassign" )
    , ( Icon.person, "person" )
    , ( Icon.personsAdd, "personsAdd" )
    , ( Icon.personsNotApplicable, "personsNotApplicable" )
